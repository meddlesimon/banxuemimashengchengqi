...
export default function ParentPage() {
        ...
        try {
            const response = await fetch('/api/parent/login', {
                ...
                body: JSON.stringify({
                    phone,
                    password,
                    skipCaptcha: true // 我们在内部逻辑中可以允许跳过验证码进行状态刷新
                }),
            });
    ...
    const captchaAppId = process.env.NEXT_PUBLIC_TENCENT_CAPTCHA_APP_ID || '191937675';
                    ...
                    <div className="card animate-in">
                        ...
                        <form className="auth-form" onSubmit={(e) => { e.preventDefault(); handleAction(view); }}>
                            ...
                            <div className="form-toggle">
                                ...
                                <button type="button" onClick={() => { setView(view === 'login' ? 'register' : 'login'); setError(''); }}>
